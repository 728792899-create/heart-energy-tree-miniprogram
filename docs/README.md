...
![V3 受保护的固定两人私人花园](../design/prototype-v3/assets/scene-protected-garden.jpg)
...
| 你的目标 | 建议顺序 | 能得到什么 |
| --- | --- | --- |
| 第一次了解产品 | [产品导览](product-tour.md) → [页面目录](page-catalog.md) | 两个角色怎样协作、主要页面和 V3 视觉基线 |
...
旧版模拟器截图已从当前文档移除。V3 原创设计源只说明视觉方向，不证明云函数已经部署、内容安全回调已经送达或双账号真机流程已经通过；新的开发者工具截图必须使用虚构 fixture 重新采集并单独标注。
